...
function checkCondition() {
  ...
  if (
    ...
    let b4Child = b7.childNodes[0].className;
    let b5Child = b8.childNodes[0].className;
    let b6Child = b9.childNodes[0].className;
...
//zerar o jogo, declarar vencedor
